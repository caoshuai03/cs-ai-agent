...
import com.cs.csaiagent.agent.model.AgentState;
...
public class ToolCallAgent extends ReActAgent {
    ...
    public ToolCallAgent(ToolCallback[] availableTools, ToolCallbackProvider toolCallbackProvider) {
        ...
        this.chatOptions = DashScopeChatOptions.builder()
                .withProxyToolCalls(true)//代理来处理工具调用逻辑
                .build();
    }
    ...
    public String act() {
        ...
        // !!! 执行工具调用
        Prompt prompt = new Prompt(getMessageList(), this.chatOptions);
        // 读取 ChatResponse 里包含的工具调用信息，然后按照 Prompt 中的上下文信息，执行对应的工具，并返回工具执行结果。
